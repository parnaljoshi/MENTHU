...
RUN R -e "install.packages(c('BiocManager', 'shiny', 'XML', 'xml2', 'shinyjs', 'rhandsontable', 'plyr', 'stringr', 'stringi', 'rentrez', 'rlist', 'DT', 'devtools', 'curl', 'plyr', 'jsonlite', 'httr', 'BiocManager'), repos='https://cloud.r-project.org/')" -e 'BiocManager::install("Biostrings")' -e 'devtools::install_github("rstudio/shiny-incubator")'
