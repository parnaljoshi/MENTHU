...
### If you already have R and/or RStudio installed, you can jump to [here](https://github.com/FriedbergLab/MENTHU#3-run-menthu-locally) to immediately start running MENTHU locally.

### If you are having issues running MENTHU locally, please check the [Troubleshooting](https://github.com/FriedbergLab/MENTHU#troubleshooting) section before requesting help.
...
[1. Download and Install R](https://github.com/FriedbergLab/MENTHU#1-download-and-install-r)

[2. Download and Install RStudio](https://github.com/FriedbergLab/MENTHU#2-download-and-install-rstudio-optional) (optional)

[3. Run MENTHU locally](https://github.com/FriedbergLab/MENTHU#3-run-menthu-locally)

[Troubleshooting](https://github.com/FriedbergLab/MENTHU#troubleshooting)
...
## Solutions:
[Simple Fixes That Resolve Most Problems](https://github.com/FriedbergLab/MENTHU#simple-fix)

[Known (And Solved) Issues](https://github.com/FriedbergLab/MENTHU#known-and-solved-issues)
...
[1. Check that you're running up-to-date MENTHU](https://github.com/FriedbergLab/MENTHU#1-up-to-date)

[2. Update Required MENTHU packages](https://github.com/FriedbergLab/MENTHU#2-update-the-required-menthu-packages)

[3. Update R and/or RStudio installations](https://github.com/FriedbergLab/MENTHU#3-update-your-r-or-rstudio-installation)
...
You can update all required packages by re-running the code [here](https://github.com/FriedbergLab/MENTHU#install-code).
...
You can also follow the instructions under [1. Download and Install R](https://github.com/FriedbergLab/MENTHU#1-download-and-install-r), but the ```installr``` package is probably quicker and easier.


On Mac, Linux, or Unix:
Follow the instructions under [1. Download and Install R](https://github.com/FriedbergLab/MENTHU#1-download-and-install-r) for your operating system.



## Known (and Solved) Issues:
[1. Failure to load 'rJava'](https://github.com/FriedbergLab/MENTHU#1-failure-to-load-rjava)
...
[A1. Possible Cause: Java is not installed](https://github.com/FriedbergLab/MENTHU#a1-possible-cause-java-is-not-installed)

[B1. Possible Cause: Java is out of date](https://github.com/FriedbergLab/MENTHU#b1-possible-cause-java-is-out-of-date)

[C1. Possible Cause: R/RStudio can't find your Java installation](https://github.com/FriedbergLab/MENTHU#c1-possible-cause-rrstudio-cant-find-your-java-installation)

[D1. Possible Cause: There is a mismatch in your Java bit-version and R/RStudio bit-version](https://github.com/FriedbergLab/MENTHU#d1-possible-cause-there-is-a-mismatch-in-your-java-bit-version-and-rrstudio-bit-version)
...
Solution: Download and install the latest version of Java for your operating system. Follow the directions in the links in [A1. Possible Cause: Java is not installed](https://github.com/FriedbergLab/MENTHU#a1-possible-cause-java-is-not-installed) to install updated Java.
...
3. If there is a mismatch, download the Java bit-version that matches your R bit-version by following the directions under [A1. Possible Cause: Java is not installed](https://github.com/FriedbergLab/MENTHU#a1-possible-cause-java-is-not-installed)
.
